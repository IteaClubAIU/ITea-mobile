...
class _$_SignUpRequestModel implements _SignUpRequestModel {
  ...
  @override
  String toString() {
    return 'SignUpRequestModel(email: $email, bin: $bin, roleType: $roleType, username: $username, password: $password, fio: $fio, socLink: $socLink, contactPhone: $contactPhone, address: $address, city: $city, country: $country)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, email, bin, roleType, username,
      password, fio, socLink, contactPhone, address, city, country);
