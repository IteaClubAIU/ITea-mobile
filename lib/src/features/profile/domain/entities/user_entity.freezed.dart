...
mixin _$UserEntity {
  ...
  String? get activationCodes => throw _privateConstructorUsedError;
...
class _$UserEntityCopyWithImpl<$Res, $Val extends UserEntity>
  ...
  $Res call({
    ...
    Object? activationCodes = freezed,
  }) {
    return _then(_value.copyWith(
      ...
      isBlocked: null == isBlocked
          ...
          : isBlocked // ignore: cast_nullable_to_non_nullable
              as bool,
      activationCodes: freezed == activationCodes
          ? _value.activationCodes
          : activationCodes // ignore: cast_nullable_to_non_nullable
              as String?,
    ) as $Val);
  }
}
...
class _$_UserEntity implements _UserEntity {
  ...
  @override
  final String? activationCodes;

  @override
  String toString() {
    return 'UserEntity(id: $id, username: $username, email: $email, roleType: $roleType, fio: $fio, socLink: $socLink, contactPhone: $contactPhone, address: $address, city: $city, country: $country, photoLink: $photoLink, bin: $bin, isBlocked: $isBlocked, activationCodes: $activationCodes)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.activationCodes, activationCodes) ||
                other.activationCodes == activationCodes));
  }
...
abstract class _UserEntity implements UserEntity {
  factory _UserEntity(
      ...
      final String? bin,
      final bool isBlocked,
      final String? activationCodes}) = _$_UserEntity;
