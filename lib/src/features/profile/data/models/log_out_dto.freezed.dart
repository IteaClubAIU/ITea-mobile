...
LogOutDto _$LogOutDtoFromJson(Map<String, dynamic> json) {
  return _LogOutDto.fromJson(json);
}
...
mixin _$LogOutDto {
  ...
  @JsonKey(ignore: true)
  $LogOutDtoCopyWith<LogOutDto> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $LogOutDtoCopyWith<$Res> {
  factory $LogOutDtoCopyWith(LogOutDto value, $Res Function(LogOutDto) then) =
      _$LogOutDtoCopyWithImpl<$Res, LogOutDto>;
  @useResult
  $Res call({String description});
}

/// @nodoc
class _$LogOutDtoCopyWithImpl<$Res, $Val extends LogOutDto>
    implements $LogOutDtoCopyWith<$Res> {
  _$LogOutDtoCopyWithImpl(this._value, this._then);
...
class _$_LogOutDto implements _LogOutDto {
  ...
  @override
  String toString() {
    return 'LogOutDto(description: $description)';
  }
